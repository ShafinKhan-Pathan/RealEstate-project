...
class Asset(models.Model):
    ...
    asset_photo = models.ImageField(upload_to='photos/%Y/%m/%d/')
    asset_photo_1 = models.ImageField(upload_to='photos/%Y/%m/%d/',blank=True)
    asset_photo_2 = models.ImageField(upload_to='photos/%Y/%m/%d/',blank=True)
    asset_photo_3 = models.ImageField(upload_to='photos/%Y/%m/%d/',blank=True)
    asset_photo_4 = models.ImageField(upload_to='photos/%Y/%m/%d/',blank=True)
